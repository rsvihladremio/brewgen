...
gh release create $VERSION --title $VERSION -d -F changelog.md target/brewgen-$VERSION-aarch64-apple-darwin.zip target/brewgen-$VERSION-x86_64-apple-darwin.zip  target/brewgen-$VERSION-x86_64-pc-windows-gnu.zip target/brewgen-$VERSION-x86_64-unknown-linux-gnu.zip
